			...
			if($row['numrows'] > 0){
				...
				try{
				    ...
				    try {
				        ...
				        $mail->SMTPAuth = true;                               
				        $mail->Username = 'nirajkarki425@gmail.com';     
				        $mail->Password = 'niraj123';                    
				        ...
				        $mail->setFrom('nirajkarki425@gmail.com');
				        
				        //Recipients
				        $mail->addAddress($email);              
				        $mail->addReplyTo('nirajkarki425@gmail.com');
				       
				        //Content
				        $mail->isHTML(true);                                  
				        $mail->Subject = 'Sajilo shop';
				        $mail->Body    = $message;
