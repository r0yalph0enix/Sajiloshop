        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="firstname" name="firstname" pattern="[A-Za-z]+"  title="Only alphabets are valid" value="<?php echo $admin['firstname']; ?>">
                  	</div>
                </div>
                <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="lastname" name="lastname" pattern="[A-Za-z]+"  title="Only alphabets are valid" value="<?php echo $admin['lastname']; ?>">
                  	</div>
                </div>
                <div class="form-group">
